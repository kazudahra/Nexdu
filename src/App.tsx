...
import ManagerDashboard from "./manager-dashboard"; // 1. Menejer faylini import qilish
...
function App() {
  ...
  if (path === "/director" || path === "/director/") {
    return <DirectorPanel onNavigate={navigate} />;
  }
  ...
  // 4. Menejer yo'nalishi (Yangi qo'shildi)
      ...
      <div className="max-w-md w-full space-y-8 bg-slate-800/80 backdrop-blur-xl p-8 rounded-3xl shadow-2xl border border-slate-700/50 relative z-10">
        ...
        <div className="mt-8 space-y-3">
          ...
          >
            ...
            <span className="text-xs bg-indigo-500/40 border border-indigo-400/30 px-2.5 py-1 rounded-lg">
              Kirish →
            </span>
          </button>
          ...
          >
            ...
            <span className="text-xs bg-emerald-500/40 border border-emerald-400/30 px-2.5 py-1 rounded-lg">
              Kirish →
            </span>
          </button>
          ...
          >
            ...
            <span className="text-xs bg-purple-500/40 border border-purple-400/30 px-2.5 py-1 rounded-lg">
              Kirish →
            </span>
          </button>
          ...
          >
            ...
            <span className="text-xs bg-sky-500/40 border border-sky-400/30 px-2.5 py-1 rounded-lg">
              Kirish →
            </span>
          </button>
        </div>
